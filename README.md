# Decocars — Catálogo con panel administrativo

Proyecto completo de catálogo de calcomanías con **HTML/CSS/JavaScript + Node.js/Express + MongoDB**.

## Qué está funcionando

Esta versión corrige la navegación móvil, carga dinámica de destacados, paginación acumulativa, filtrado público de productos/categorías ocultos, validaciones de categorías, búsqueda administrativa, protección CSRF y configuración CORS segura.
